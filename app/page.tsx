  ...
  return (
    <div className="flex flex-col items-center px-6 pt-32 pb-20 min-h-screen bg-gradient-to-br from-purple-100 via-white to-blue-100 text-center space-y-20">
      ...
      <section className="max-w-2xl w-full space-y-6">
        ...
        <p className="text-xl text-gray-700">Instantly uncover profiles, carrier, risk score and more. SafeSwipe is your AI-powered truth engine.</p>
      ...
      <section className="max-w-3xl w-full">
        <form className="bg-white shadow-lg rounded-2xl p-6 space-y-4 text-left" onSubmit={(e) => e.preventDefault()}>
          ...
          <p className="text-xs text-gray-500 text-center mt-2">Secure & Encrypted. Your searches are 100% private.</p>
        </form>
      </section>
      ...
      <section className="w-full max-w-4xl text-center">
        <div className="bg-white shadow rounded-xl p-6 space-y-2">
          ...
          <p className="text-gray-600 text-sm">Thousands of searches scanned securely every month.</p>
        </div>
      </section>
