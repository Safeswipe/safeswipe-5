  ...
  return (
    <div className="flex flex-col items-center px-6 pt-32 pb-20 space-y-32 min-h-screen text-center bg-gradient-to-br from-purple-100 via-white to-blue-100">
      ...
      <section className="space-y-6 max-w-3xl">
        ...
        <p className="text-xl text-gray-700">Uncover profiles, photos, and public data across the internet.</p>
        ...
        <form className="bg-white shadow-lg rounded-2xl p-6 space-y-4 text-left" onSubmit={(e) => e.preventDefault()}>
          ...
          <input
            ...
            onChange={(e) => {
              ...
              sessionStorage.setItem('safeswipe_input', e.target.value);
            }}
          ...
          <div className="mt-10 w-full bg-white border border-purple-300 rounded-md shadow-md p-6 space-y-4 text-left">
            ...
            <div className={isPaid ? "space-y-4" : "space-y-4 blur-sm pointer-events-none select-none"}>
              ...
              <div className="text-left text-gray-700 space-y-2">
                ...
                <p>SafeSwipe searched over <strong>74.6 billion images</strong> but didn’t find any matches.</p>
              ...
              {isUsername && (
                <div className="pt-4">
                  ...
                  <p><a className="text-purple-700 underline" href={`https://instagram.com/${inputValue.replace('@', '')}`} target="_blank">Instagram</a></p>
                  <p><a className="text-purple-700 underline" href={`https://facebook.com/${inputValue.replace('@', '')}`} target="_blank">Facebook</a></p>
                </div>
              )}
              {isEmail && (<p className="text-gray-700">No public data found for <strong>{inputValue}</strong>.</p>)}
              {isPhone && (<p className="text-gray-700">No public data found for <strong>{inputValue}</strong>.</p>)}
            </div>
            {!isPaid && (
