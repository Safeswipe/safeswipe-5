      ...
      result.innerHTML = `
        <div class='mt-4 w-full bg-white border border-purple-300 rounded-md shadow-md p-4'>
          ...
          <div class='flex flex-col md:flex-row gap-4'>
            <a href='https://buy.stripe.com/aEU9BL4wEep9fXGeUX' target='_blank' rel='noopener noreferrer' class='block w-full px-6 py-3 bg-purple-600 hover:bg-purple-700 text-white text-center rounded-md font-semibold shadow'>Unlock Unlimited – $19.99</a>
            <a href='https://buy.stripe.com/7sIeW5bZ6ch18ve4gi' target='_blank' rel='noopener noreferrer' class='block w-full px-6 py-3 border border-purple-500 text-purple-700 text-center rounded-md font-semibold shadow'>One-Time Report – $4.99</a>
          </div>` : ''}
        </div>`;
    }, 3000);
  };
